...
export default function LoadingAnimation() {
  // Check sessionStorage synchronously to avoid showing on SPA navigation
  ...
  return (
    <div
      style={{
        ...
        pointerEvents: "none",
        animation: `dh-fade ${TOTAL_MS}ms ease forwards`,
      }}
    >
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 160, height: 160 }}>
        <svg viewBox="0 0 120 120" role="img" aria-label="Davin Harding" style={{ width: "100%", height: "100%" }}>
          <style>{`
            ...
            @keyframes dh-fade{0%,75%{opacity:1}100%{opacity:0;visibility:hidden}}
          `}</style>
